/**
 * dialog.tsx — Modal dialog (Radix). Used for create/edit flows that don't
 * deserve their own page (e.g. "Create list", "Add tag"). Full-screen on
 * mobile via responsive max-width.
 */
"use client";
